            ...
            <div class="top_card">
                ...
                <div class="patient_detail">
                    <div class="card name_card">
                        ...
                        <button type="button" data_src="${data == '' ? '' : data.id}" class="edit_btn"><span class='switch_icon_edit'></span> Edit</button>
                    ...
                    <div class="card">
                        ...
                        <div class="icon_card">
                            ...
                            <p>${this.date_formatter(data == '' ? '2001-02-01' : data.dob)} (${data == '' ? '' : data.age} years)</p>
                        </div>
