...
<div class="medicine_cont">
    ...
    <br-form btn_class="add_user_btn" class="medicine_top">
        ...
        <div class="medicine_content">
            ...
            <br-input label="Medicine Name" type="text" placeholder="Enter medicine name" styles="
            ...
            <br-input label="Medicine Code" type="number" styles="
                        border-radius: var(--input_main_border_r);
                        width: 400px;
                        padding: 10px;
                        height: 41px;
