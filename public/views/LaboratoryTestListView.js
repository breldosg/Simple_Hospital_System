...
export class LaboratoryTestListView {
    constructor() {
        window.laboratory_search_test_list = this.search_medicine.bind(this);
        this.medicineData = [];
        this.batchNumber = 1;
    ...
    async PreRender() {
        ...
        this.main_component = document.querySelector('.laboratory_search_test_list');
    ...
    searchRadiologyView() {
        return `
        <br-form callback="laboratory_search_test_list">
    ...
    ViewReturn() {
        return `
    <div class="laboratory_search_test_list">
