...
export class UpdateProcedurePricePopUpView {
    constructor() {
        window.update_procedure_price_popup_form = this.update_price.bind(this);
    }
...
<div class="container update_pharmacy_product_price_popup">
    ...
    <br-form callback="update_procedure_price_popup_form" class="slides">
        <div class="slide">
        <div class="head_cont">
...
`;
    ...
    async update_price(data) {
        ...
        try {
            const response = await fetch('/api/procedure/update_procedure_price', {
                method: 'POST',
                headers: {
            ...
            if (result.success) {
                ...
                this.close_popup()
                dashboardController.viewBillingProcedureView.fetchAndRenderData();
            } else {
