...
export class CreateLaboratoryTestPopUp {
    ...
    ViewReturn(loader = '') {
        ...
        <div class="container create_radiology_popup">
            <div class="slides anima" callback="CreateLaboratoryTestPopUp">
                <div class="slide">
                    <div>
                        <p class="heading"></p>
                    </div>
    ...
    update_view_after_loading(categories, radiologyData = null) {
        const title = this.isUpdate ? "Update Laboratory Test" : "Create Laboratory Test";
    ...
    async CreateLaboratoryTest(data) {
        ...
        const endpoint = this.isUpdate ? '/api/laboratory/update_examination' : '/api/laboratory/create_examination';
