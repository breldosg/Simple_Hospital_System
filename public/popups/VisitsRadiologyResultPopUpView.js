...
export class VisitsRadiologyResultPopUpView {
    constructor() {
        this.data = null;
        this.active_tab = '';
    }
    ...
    async PreRender(params = '') {
        ...
        this.container = document.querySelector('.radiology_result_popup');
    ...
    ViewReturn() {
        return `
<div class="container radiology_result_popup">
    <div class="cont_heading">
        <h4 class="heading">${this.data.radiology_name} </h4>
...
`;
    ...
    render_sections(data) {
        ...
        this.render_report_section(data.report);
        this.render_file_list_section(data.report_attachment);

    }

    render_report_section(data) {
        const cont = this.container.querySelector('#report');
        cont.innerHTML = '';
