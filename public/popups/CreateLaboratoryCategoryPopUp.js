...
export class CreateLaboratoryCategoryPopUp {
    constructor() {
        window.CreateLaboratoryCategoryPopUpFunction = this.CreateLaboratoryCategory.bind(this);
    ...
    update_view_after_loading(categoryData = null) {
        const title = this.isUpdate ? "Update Laboratory Category" : "Create Laboratory Category";
        const submitText = this.isUpdate ? "Update" : "Submit";

        return `
        <br-form class="slides anima" callback="CreateLaboratoryCategoryPopUpFunction">
            <div class="slide">
                <div>
    ...
    async CreateLaboratoryCategory(data) {
        ...
        const endpoint = this.isUpdate ? '/api/laboratory/update_laboratory_category' : '/api/laboratory/create_laboratory_category';
        ...
        try {
            ...
            if (result.success) {
                ...
                dashboardController.laboratoryTestCategoryListView.fetchAndRenderData();
            } else {
