...
export class UpdatePharmacyProductPricePopUpView {
    constructor() {
        window.update_pharmacy_product_price_popup_form = this.update_price.bind(this);
    }
...
<div class="container update_pharmacy_product_price_popup">
    ...
    <br-form callback="update_pharmacy_product_price_popup_form" class="slides">
        <div class="slide">
        <div class="head_cont">
...
`;
    ...
    async update_price(data) {
        ...
        try {
            const response = await fetch('/api/pharmacy/update_pharmacy_product_price', {
                method: 'POST',
                headers: {
