...
export class UpdateConsultationPricePopUpView {
    constructor() {
        window.update_consultation_price_popup_form = this.update_price.bind(this);
    }
...
<div class="container update_pharmacy_product_price_popup">
    ...
    <br-form callback="update_consultation_price_popup_form" class="slides">
        <div class="slide">
        <div class="head_cont">
...
`;
    ...
    async update_price(data) {
        ...
        try {
            const response = await fetch('/api/billing/update_consultation_price', {
                method: 'POST',
                headers: {
            ...
            if (result.success) {
                ...
                this.close_popup()
                dashboardController.viewBillingConsultationView.fetchAndRenderData();
            } else {
