...
export class VisitImplantableDevicesCardView {
    ...
    ViewReturn() {
        ...
        card.classList.add('implantable_devices_cont_cont');

        card.innerHTML = `
            <div class="head_part">
                <h4 class="heading">Implantable Devices</h4>

                <div class="add_btn" id="add_implantable_devices" >
                    <span class='switch_icon_add'></span>
                </div>
            </div>

            <div class="body_part implantable_devices_cont">
        ...
        const edit_btn = card.querySelector('.implantable_devices_cont_cont #add_implantable_devices');
        edit_btn.addEventListener('click', () => {
            // dashboardController.visitPlanForNextVisitPopUpView.PreRender();
            console.log('add_implantable_devices not yet');
