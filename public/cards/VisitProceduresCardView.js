...
export class VisitProceduresCardView {
    ...
    ViewReturn() {
        ...
        card.classList.add('procedures_cont_cont');

        card.innerHTML = `
            <div class="head_part">
                <h4 class="heading">Procedures</h4>

                <div class="add_btn" id="add_procedures" >
                    <span class='switch_icon_add'></span>
                </div>
            </div>

            <div class="body_part procedures_cont">
        ...
        const edit_btn = card.querySelector('.procedures_cont_cont #add_procedures');
        edit_btn.addEventListener('click', () => {
            // dashboardController.visitPlanForNextVisitPopUpView.PreRender();
            console.log('add_procedures not yet');
